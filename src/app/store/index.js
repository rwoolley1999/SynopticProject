...
import { LoadState, SaveState } from '../state/local_storage.js';

const sagaMiddleware = createSagaMiddleware();


// loading state to redux store
    ...
    combineReducers({
        ...
        mediaFiles(mediaFiles = defaultState.mediaFiles, action) {
            switch (action.type) {
                ...
                case mutations.ADD_MEDIA_FILE_IMAGE:
                    return mediaFiles.map(mediaFile => {
                        return (mediaFile.id === action.mediaFileID) ?
                            { ...mediaFile, imageURL: action.imageURL } :
                            mediaFile;
                    });
